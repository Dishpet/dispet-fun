...
export const SocialMediaGenerator = () => {
    ...
    if (selectedFormat && uploadedImage) {
        ...
        <div className="w-full max-w-5xl mx-auto px-4">
            ...
            <Tabs defaultValue="instagram" className="w-full space-y-8">
                ...
                <TabsContent value="instagram">
                    <SocialTemplateSelector platform="instagram" onSelect={handleFormatSelect} />
                </TabsContent>

                <TabsContent value="facebook">
                    <SocialTemplateSelector platform="facebook" onSelect={handleFormatSelect} />
                </TabsContent>
            </Tabs>
        </div>
    );
